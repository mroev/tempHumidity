...
//mxconfig.clkphase = true; // Change this if you have issues with ghosting.
//mxconfig.driver = HUB75_I2S_CFG::RUC7258; // Change this according to your pane.
